...
$username="root";
$password="bhoomika";
$con=mysqli_connect($server,$username,$password,"Banking database");
if(!$con){
...
<div class="container-fluid myclass" style="padding:0px; margin:0px;">
        ...
        <nav class="navbar navbar-expand-sm  navbar-toggler navbar-light" style="background-color:transparent; background-color:#b3e5fc; opacity:1;"> 
            ...
            &nbsp;
            <div class="navbar-brand font-weight-bold " id="title" data-anijs="if: mouseover, do: slideInUp animated" style="color:#01579b;font-family: 'Courgette', cursive;font-size:2em;">
                &nbsp;Sparks Trust Bank
            </div>
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02" style="float:right;">
                ...
                <li class="nav-item">
                        <a class="nav-link " href="index.php" style="color:01579b;font-weight:1em;">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="transferrecords.php" style="color:#01579b;font-weight:1em;">
                            <div style="padding-left:20px;" >
...
<div class="row">
    ...
    <div style="padding-top:2%;display:inline;"><h4 class="font-weight-bold" style="color:#01579b;font-size:2em;;display:inline;margin:10px 5px 0px 5px;padding-top:1%">Customer Details</h4>
    </div>
        <br><br>
    ...
    <div class="col-sm" style="padding:1% 3%;">
        <div >
                    ...
                    <span class="font-weight-bold" style="color:#01579b;font-size:1.8em;line-height:1em;display:inline;margin:10px 5px 0px 5px;padding-top:1%">Money Transfer</span>
                    </div><br><br>
                ...
                <?php
                $db = mysqli_connect("localhost", "root", "bhoomika", "Banking database");
