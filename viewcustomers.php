<?php
    $con = mysqli_connect("localhost", "root", "bhoomika", "Banking database");
?>
...
<div class="usertable">
    ...
    <h3 class="font-weight-bold"style="text-align:center;color:#01579b;font-family: 'Courgette', cursive;font-size:2.2em;padding:3%;">Customers</h3>
    <table id="myTable">
          <tr>
            <th>Customer ID</th>
            <th>Name</th>
